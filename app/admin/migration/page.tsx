...
// WooCommerce Migration Admin Interface
...
export default function MigrationPage() {
  ...
  const [categoryFilter, setCategoryFilter] = useState('wicket keeping')
      ...
      <>
        ...
        <main className="min-h-screen bg-gray-50 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-muted-foreground">Loading migration interface...</p>
          </div>
        </main>
        <Footer />
      </>
            ...
            <EnhancedCard className="p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  >
                    <option value="wicket keeping">Wicket Keeping Products (WK Gloves, WK Pads, Inner Gloves)</option>
                    <option value="ball">Cricket Balls (Previous Test)</option>
                    <option value="cricket bat">Cricket Bats Only</option>
                    <option value="helmet">Helmets Only</option>
                    <option value="all">All Products</option>
                  </select>
                  <p className="text-sm text-gray-500 mt-1">Wicket keeping products including gloves, pads, junior items, and inner gloves</p>
                </div>
                        ...
                        <div className="bg-blue-50 p-4 rounded-lg">
                          ...
                          <div className="flex gap-4 text-sm text-blue-700">
                            <div className="flex items-center gap-1">
                              ...
                              <span>{testResult.stats.totalProducts} Products</span>
                            </div>
                            <div className="flex items-center gap-1">
