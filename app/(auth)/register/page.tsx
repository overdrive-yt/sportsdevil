...
import { useEnhancedRegister } from '../../../hooks/use-auth-store'
...
export default function RegisterPage() {
  ...
  const registerMutation = useEnhancedRegister()
    ...
    <div className="min-h-screen bg-gradient-to-br from-primary/5 to-secondary/5 flex items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center relative pt-16 pb-5">
          ...
          <CardTitle className="text-2xl font-bold mb-3">Join Sports Devil</CardTitle>
          <CardDescription className="text-base">
            Create your account to access exclusive sports equipment deals and track your orders
          </CardDescription>
        </CardHeader>
            ...
            <div className="space-y-4 pt-2">
              <div className="flex items-start space-x-3">
                <Checkbox
                  ...
                  className="mt-0.5"
                />
                <Label htmlFor="agreeToTerms" className="text-sm leading-relaxed peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
                  I agree to the{' '}
              ...
              {errors.agreeToTerms && (
                <p className="text-sm text-destructive ml-7">{errors.agreeToTerms.message}</p>
              )}
              ...
              <div className="flex items-start space-x-3">
                ...
                />
                <Label htmlFor="subscribeNewsletter" className="text-sm leading-relaxed cursor-not-allowed opacity-70">
                  Subscribe to our newsletter for updates and special offers - coming soon
                </Label>
              </div>
            </div>

            <Button type="submit" className="w-full h-11 mt-6" disabled={isSubmitting || !agreeToTerms}>
              {isSubmitting ? (
                <>
